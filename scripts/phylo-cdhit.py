...
def main():
    ...
    parser.add_argument("--accession", help="Accessions to make representative in cluster.", type=set, default=())
    parser.add_argument("--positive", help="Keywords to make representative in cluster.", type=set, default=())
